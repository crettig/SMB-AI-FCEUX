...
function keepGoing()
--If the player is in certain states, we want the player to be able to continue
--such as autowallking
--or when the player is transitioning in a pipe
...
local playerState = memory.readbyte(0x000E)
	...
	if playerState == 0x00 then keepGoing = true
	elseif playerState == 0x01 then keepGoing = true
	elseif playerState == 0x02 then keepGoing = true
	elseif playerState == 0x03 then keepGoing = true
	elseif playerState == 0x04 then keepGoing = true
	elseif playerState == 0x05 then keepGoing = true
	elseif playerState == 0x07 then keepGoing = true
	elseif playerState == 0x09 then keepGoing = true
	elseif playerState == 0x0C then keepGoing = true
	end
return keepGoing
...
while true do
	...
	if keepGoing() then
		...
		timeout = TimeoutConstant
		keepGoingFrames = keepGoingFrames + .5
	end 
	...
	if timeout + timeoutBonus <= 0 or isDead() then
		local fitness = rightmost - pool.currentFrame / 2 + keepGoingFrames
